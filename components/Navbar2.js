        ...
        <div className={`position-fixed bg-white w-100 ${styles['navbar-height']} row`}>
            <div className={`${styles['icon-logo-responsive']} col-6    d-flex align-items-center`}>
                <div className='ms-5 logo'>
                    <Link href='/landing'><Image src="/assets-img/purple-logo.png" width={150} height={40} alt="wkwkwk"></Image></Link>
                </div>
            </div>
            <div className={`${styles['navigation-responsive']} col-6  d-flex align-items-center justify-content-end gap-3`}>
                <div className={`${styles['navigation-responsive-icon']} ms-3`}>
                    <Link href='/landing'><Image src="/assets-img/only logo.png" width={50} height={40} alt="wkwkwk"></Image></Link>
                </div>
                <div>
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <div className="modal-content d-flex justify-content-center align-items-center h-100">
                            <div className='img'>
                                <Image src="/assets-img/notifikasi kosong.png" width={100} height={100} alt="wkwk"></Image>
                            </div>
                            <div className='msg'>
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <div className="modal-content d-flex justify-content-center align-items-center h-100 gap-3">
                            ...
                            <div className='link-1'>
                                ...
                                <button className={`${gStyles['open_sans_sb']} ${styles['text-purple-link']} btn ${styles['btn-white']}`} onClick={() => onLogout()}>
                                    Logout
                                </button>
                            </div>
                        </div>
