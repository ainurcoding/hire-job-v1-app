...
export async function getServerSideProps(context) {
    ...
    try {
        ...
        const responseSkill = await axios({
            method: 'GET',
            url: `${process.env.APP_BACKEND_URL}/v1/skill/show_by_user_id/83d9e925-fe11-4a29-8e63-d9fb907cab64`
        })
                            ...
                            >
                                <div className={` ${styles["img-card"]}`}>
                                    <Image src={item.ava_url ? (
                                        ...
                                        style={{ borderRadius: "50%" }} width={150} height={150} alt="avatar"></Image>
                                </div>
                            </div>
                            <div className={`${styles["info-wrapper"]} d-flex flex-column`}>
                                    ...
                                    <p className={`${gStyle["open_sans_lt"]}`}>
                                        {
                                            item.job_spec ? (
                                                ...
                                                <>data job spesification not found please click on edit profile to complete this</>
                                            )
                                        }
                                    </p>
                                </div>
                                        ...
                                        <p className={`text-muted  ${gStyle["open_sans_lt"]}`}>
                                            {
                                                item.domisli ? (
                                                    ...
                                                    <>data job domisli not found please click on edit profile to complete this</>
                                                )
                                            }
                                        </p>
                                    </div>
                                    ...
                                    <p className={`text-muted  ${gStyle["open_sans_lt"]}`}>
                                        {
                                            item.job_type ? (
                                                ...
                                                <>data job type not found please click on edit profile to complete this</>
                                            )
                                        }
                                    </p>
                                </div>
                                    ...
                                    <p className={`text-muted  ${gStyle["open_sans_lt"]}`}>
                                        {
                                            item.personal_desc ? (
                                                ...
                                                <>data job desc not found please click on edit profile to complete this</>
                                            )
                                        }
                                    </p>
                                </div>
                                ...
                                <div className={`ms-3 mb-5 skills-wrapper d-flex flex-column`}>
                                    ...
                                    <div className={`${styles["wrap-skill"]} row gap-2`}>
                                        {
                                            props.dataSkill.map((itemSkill) => (

                                                itemSkill.name_skill ?
                                                    (
                                                        <div className="skill-name col-5">
                                                            ...
                                                            >
                                                                <p className={`${styles["open_sans_sb h6"]}`}>{itemSkill.name_skill}</p>
                                                            </button>
                                                        </div>
                                                    )
                                                    :
                                                    (
                                                        <div className="skill-name col-5">
                                                            <p className={`${gStyle['open_sans_sb']} h6`}>u don't have anyone skill data, please click edit profile to add your skill</p>
                                                        </div>
                                                    )
                                            ...
                                            <p className={`${styles["open_sans_lt"]} text-muted`}>
                                                {
                                                    item.ig_account ? (
                                                        ...
                                                        <>your instagram account data not found please click edit profile to add</>
                                                    )
                                                }
                                            </p>
                                        </div>
                                            ...
                                            <p className={`${styles["open_sans_lt"]} text-muted`}>
                                                {
                                                    item.git_account ? (
                                                        ...
                                                        <>your github account data not found please click edit profile to add</>
                                                    )
                                                }
                                            </p>
                                        </div>
